    ...
    try:
        ...
        unpublished_content = [
            ...
            },
            {
                ...
                'content_text': 'Master Docker containerization with this in-depth tutorial covering production best practices. Learn how to write efficient Dockerfiles using multi-stage builds, optimize image sizes, implement proper security measures, and set up Docker Compose for development environments.',
                'content_type': ContentTypeEnum.VIDEO,
                'status': ContentStatusEnum.DRAFT,
                'author_id': author.id,
            ...
            },
            {
                ...
                'content_text': 'Discover powerful Python optimization techniques in this detailed video tutorial. Learn profiling tools to identify bottlenecks, understand CPython internals, use caching strategies effectively, and leverage built-in optimization features.',
                'content_type': ContentTypeEnum.VIDEO,
                'status': ContentStatusEnum.DRAFT,
                'author_id': author.id,
            ...
            },
            {
                ...
                'content_text': 'Microservices architecture has become the standard for building scalable, resilient applications. This comprehensive article covers everything you need to know about designing, implementing, and maintaining microservices systems. Learn about service decomposition strategies, inter-service communication patterns, and data consistency approaches.',
